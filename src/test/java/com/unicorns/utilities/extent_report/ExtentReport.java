package com.unicorns.utilities.extent_report;
...
public class ExtentReport {
    ...
    private static final String extentReportPath = System.getProperty("user.dir") + "/resources/reports/";
    private static final String extentReportConfigPath = System.getProperty("user.dir") + "/src/test/java/com/unicorns/utilities/extent_report/";
    ...
    public static String getExtentReportConfigPath() {
        ...
        if (extentReportConfigPath.contains("Siebel-Framework")) {
            configPath = extentReportConfigPath;
        } else {
            configPath = System.getProperty("user.dir") + "/src/test/java/com/unicorns/utilities/extent_report/";
        }
